...
| II.21 | *Pene doppo i sollievi* — «Mi dichiarò però che resta nell'anima passiva capacetà ad essere contrariata dalle passioni quando Dio l'abandonasse» (inchiostro scuro, **mano esterna**) | Glossa prudenziale **di mano esterna** sull'impeccabilità (§6 6.3.3, II.XXI,29); **non** declaratio autoriale, **non** T3 |
...
| 6.3.3 · II.XXI,29 | riequilibrio (2) | rischio | risk-impeccabilita | 0.92 | 0.85 | 0.765 | high |
...
**Nota loci (risolti — v1.8).** Le righe **6.1.3** e **6.3.3**, in precedenza etichettate `III.VIII,8`, sono state riassegnate sul riscontro delle trascrizioni: **6.1.3** («divenuta un altro Dio», panteismo, attenuatio) è a **III.VII,8** (c. 173r); **6.3.3** (impeccabilità) è una glossa **di mano esterna** («Mi dichiarò però che resta nell'anima passiva capacetà ad essere contrariata dalle passioni quando Dio l'abandonasse»), a inchiostro scuro, in **II.XXI** (c. 146r, **§ 29**); **non** è una *declaratio* autoriale né una delle tre «mi dichiaro» d'autrice. La riga **6.9.1** (`III.VIII,34`, «totale sicurtà… non per fidar di sé stessa») è già corretta e resta la glossa anti-sostanziale propria di III.8.
