...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- co-occorrenza / cardinalita' degli assi sul seg. Cardinalita' CONFERMATE sul corpus (697 seg)
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- axis co-occurrence / cardinality on the seg. Cardinalities CONFIRMED on the corpus (697 seg)
